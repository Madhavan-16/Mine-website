...
- **Commit `mine.db` and `uploads/` to git** when you want local catalogue data on Azure after deploy.
- **Azure data policy:** UI / images / non-knowledge content update from local push only; **knowledge artefacts** are bidirectional (see [docs/azure-deploy.md](docs/azure-deploy.md)).
